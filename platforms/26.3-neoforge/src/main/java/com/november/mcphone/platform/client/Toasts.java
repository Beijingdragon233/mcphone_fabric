 ...
 * <h2>为什么这一层不能省</h2>
 *
 * 老那三支上它是 {@code Minecraft} 上的一个 getter。26.x 这个 getter 整个没了：
 * 管理器挂在 {@code Gui} 上（取口 {@code Gui#toastManager()}），那个类也从
 * {@code ToastComponent} 改名成了 {@code ToastManager}。
...
public final class Toasts {
     ...
     */
    public static ToastManager manager(Minecraft mc) {
