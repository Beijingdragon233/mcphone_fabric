package com.november.mcphone.api.sdk.waypoints;

import com.november.mcphone.api.sdk.SdkVersions;

/**
 * 传送点 SDK（B 档占位） 的版本号（施工方案 §23.4）。
 *
 ...
 * 为什么不能是接口字段，也都写在那儿。
 */
public final class WaypointsApi {

    private WaypointsApi() {
    }

    /** manifest {@code sdk} 段里写的键。 */
    public static final String KEY = "waypoints";
